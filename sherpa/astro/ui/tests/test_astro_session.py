...
def check_moncar(ncores, fr, g1, g2) -> None:
    ...
    match ncores:
        ...
        case 1:
            # The results depend on OS/architecture, but rather than
            # check for this - as it is unclear what is the cause of
            # this difference - just check we match one of the
