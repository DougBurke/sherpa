...
#
    ...
    def set_arf(self, id, arf=None,
        ...
        # Delete the entry but make sure the "parent" (so idval for
        # source and idval/bkg_id for background) exists.
        #
        if bkg_id is None:
        ...
        elif idval in self._load_bkg_arf_store:
            if bkg_id in self._load_bkg_arf_store[idval]:
                with suppress(KeyError):
                    del self._load_bkg_arf_store[idval][bkg_id][resp_id]
            else:
    ...
    def load_arf(self,
        ...
        kwargs = {"resp_id": resp_id, "bkg_id": bkg_id}
        store = FileStore(self.load_arf, idval, arg, kwargs=kwargs)
    ...
    def set_rmf(self, id, rmf=None,
        ...
        elif idval in self._load_bkg_rmf_store:
            if bkg_id in self._load_bkg_rmf_store[idval]:
                with suppress(KeyError):
                    del self._load_bkg_rmf_store[idval][bkg_id][resp_id]
            else:
    ...
    def load_rmf(self,
        ...
        kwargs = {"resp_id": resp_id, "bkg_id": bkg_id}
        store = FileStore(self.load_rmf, idval, arg, kwargs=kwargs)
    ...
    def set_bkg(self, id, bkg=None,
        ...
        # TODO: What do we want to reset/ensure here?
        if idval not in self._load_bkg_store:
            self._load_bkg_store[idval] = {}
